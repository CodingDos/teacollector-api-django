"""
Django settings for teacollector project.
...
SECRET_KEY = 'django-insecure-c!f1@ruby+58f7e$d5*o@nj+d$4!l*ao8khqp*q*@jz32d*wd3'
...
ROOT_URLCONF = 'teacollector.urls'
...
WSGI_APPLICATION = 'teacollector.wsgi.application'
